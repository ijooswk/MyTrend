...
무단 전재 배포 저작권 제공 사실 이유 목적 중심 대상 통한 따른 관한 위한 대비해 관련해 이라는 라는 한다는 위해서
대응 가능 위기 시장 추세 검토 논의 강조 주목 관심 지원 운영 활용 적용 도입 확보 추가 기반 부문 업계 당국 형태 종류 수단
평가 판단 본격 최대 최소 역대 사상 각각 우선 방향 부담 효율 대규모 소규모 일환 관측 분위기 행보 점검 모색 마무리""".split())
...
make made take takes set sets put puts way ways thing things lot use used using big small good best worse better
market markets crisis response responses issue issues plan plans sector sectors measure measures effort efforts
possible ability move moves trend trends concern concerns demand support level levels case cases situation""".split())
